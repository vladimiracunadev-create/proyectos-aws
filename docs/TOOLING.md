...
> [!NOTE]
> La demo de Kubernetes utiliza `kind` (Kubernetes in Docker) para ejecutar validaciones localmente.
> **Esto NO está relacionado con el Caso K (EKS en AWS)**, que es un proyecto planificado.
> Esta sección es completamente opcional y sirve para demostrar las capacidades del tooling.
