...
Scripts de auditoria de costos, cuenta, creditos, Free Tier, presupuestos y dashboards de FinOps, generando salidas locales automaticas bajo `.tmp/skill-output/`.
